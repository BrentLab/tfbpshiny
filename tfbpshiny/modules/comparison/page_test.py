"""
Standalone app for developing the Comparison (DTO) analysis page in isolation.
...
from tfbpshiny.modules.comparison.ui import analysis_sidebar_ui, analysis_workspace_ui

_ACTIVE_MODULE = "composite"
_LABEL = "Comparison Analysis"
